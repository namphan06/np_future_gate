...
class _CV5InputScreenState extends State<CV5InputScreen> {
  ...
  Future<void> _initializeData() async {
    if (widget.cvId != null) {
      ...
      try {
        ...
        setState(() => _cvData = data ?? _getEmptyCV5Data());
      } catch (e) {
        _showError('Không thể tải dữ liệu CV: $e');
        setState(() => _cvData = _getEmptyCV5Data());
      } finally {
        setState(() => _isLoading = false);
      }
    } else {
      _cvData = _getEmptyCV5Data();
    }
  }

  Map<String, dynamic> _getEmptyCV5Data() => {
    'mcv': 'CV005',
    'type': 'general',
    'personal_info': {
      'full_name': '',
