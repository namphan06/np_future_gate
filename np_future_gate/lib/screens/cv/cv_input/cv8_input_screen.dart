...
class _CV8InputScreenState extends State<CV8InputScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.cvId != null ? 'Chỉnh sửa Finance CV' : 'Tạo Finance CV'),
        actions: [
          IconButton(
      ...
      body: SingleChildScrollView(
        ...
        child: Cv8(data: _cvData, onSectionTap: _onSectionTap),
      ),
    );
  }
}
