...
class CV7InputScreen extends StatefulWidget {
  const CV7InputScreen({super.key, this.cvId});
  final String? cvId;
...
class _CV7InputScreenState extends State<CV7InputScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.cvId != null ? 'Chỉnh sửa Design CV' : 'Tạo Design CV'),
        actions: [
          IconButton(
      ...
      body: SingleChildScrollView(
        ...
        child: Cv7(data: _cvData, onSectionTap: _onSectionTap),
      ),
    );
  }
}
