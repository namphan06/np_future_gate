...
import 'package:np_future_gate/features/candidate/controllers/search_candidate_controller.dart';
...
class _SearchPageCandidateState extends State<SearchPageCandidate> {
        ...
        Wrap(
          ...
          children: jobWorkTypes.map((workType) {
            ...
            return FilterChip(
              ...
              selected: isSelected,
              onSelected: (selected) {
                _controller.setSelectedWorkType(selected ? workType : null);
              },
        ...
        Container(
          ...
          child: DropdownButtonHideUnderline(
            child: DropdownButton<String>(
              ...
              onChanged: (value) {
                _controller.setSelectedCity(value);
              },
            ),
          ),
        ),
        ...
        Container(
          ...
          child: DropdownButtonHideUnderline(
            child: DropdownButton<String>(
              ...
              onChanged: (value) {
                _controller.setSelectedExperience(value);
              },
            ),
          ),
        ),
        ...
        Container(
          ...
          child: DropdownButtonHideUnderline(
            child: DropdownButton<String>(
              ...
              onChanged: (value) {
                _controller.setSelectedJobType(value);
              },
            ),
          ),
        ),
  ...
  // ============================================================
  // ACTIONS (UI-only: navigation, error display)
  // ============================================================
